<html>
	...
	<body>
		...
		<div class="inicio">
			<img class="fondo" src="imagenes/cosmeticos.jpg">
			<img class="carrito" src="imagenes/carrito.png">
			<h1>Ordena productos de belleza desde la comodidad de tu hogar</h1>
		</div>
		<h1>Productos destacados</h1>
		<div class="contenedor">
			 <?php
				if($link){
					$result=mysqli_query($link,"select id_producto,nombre,precio,marca,nombre_categoria,nombre_subcategoria,imagen from producto,subcategoria,categoria where destacado=1 and producto.activo= 1 and producto.id_subcategoria=subcategoria.id_subcategoria and subcategoria.id_categoria=categoria.id_categoria");
					while($row=mysqli_fetch_array($result)){
						echo "<div class='producto'>
								<a href='plantilla_producto.php?id_producto=",$row["id_producto"],"'><img src='",$row["imagen"],"'/></a>
